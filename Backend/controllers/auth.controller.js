...
export const signup = async (req, res) => {
	try {
		const { fullName, username, password, confirmPassword, gender, profession} = req.body;
        ...
        if(profession){
            ...
            if (newTherapist) {
                ...
                generateTokenAndSetCookie(newTherapist._id, res);
            await newTherapist.save();
                ...
                res.status(201).json({
                    ...
                    profilePic: newTherapist.profilePic,
                });
            }
             else {
